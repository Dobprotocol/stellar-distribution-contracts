...
use soroban_sdk::{
    ...
    xdr::{
        self, ContractIdPreimage, ContractIdPreimageFromAddress, Limits,
...
mod contract {
    soroban_sdk::contractimport!(
        file = "../../target/wasm32-unknown-unknown/release/soro_splitter.wasm"
    );
}
    ...
    let expected_auth = AuthorizedInvocation {
        ...
        sub_invocations: vec![AuthorizedInvocation {
            function: AuthorizedFunction::CreateContractV2HostFn(xdr::CreateContractArgsV2 {
                ...
                constructor_args: xdr::VecM::default(),
            }),
            sub_invocations: vec![],
        }],
    };

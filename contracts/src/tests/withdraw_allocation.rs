...
fn happy_path() {
    ...
    // shareholder (80.5%): 995_000_000 * 8050 / 10000 = 800_975_000
    ...
    assert_eq!(
        ...
        300_975_000  // 800_975_000 - 500_000_000
    );
    assert_eq!(token.balance(&shareholder), 500_000_000);

    splitter.withdraw_allocation(&token_address, &shareholder, &300_975_000);
    assert_eq!(splitter.get_allocation(&shareholder, &token_address), 0);
    assert_eq!(token.balance(&shareholder), 800_975_000);
}
